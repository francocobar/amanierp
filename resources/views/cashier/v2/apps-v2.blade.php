...
<div class="col-md-6">
    ...
    <h2><a href="{{route('do.cashier.employee-incentive', ['b'=>Crypt::encryptString($branch->id)]) }}/unset" class="btn btn-warning">Insentif Untuk Karyawan yang belum dibagikan</a></h2>
