...
@section('content')
<h2>Tambah Transaksi Cabang | <a class="btn btn-default" href="{{route('get.cashier.v2',['branch'=>$branch->id])}}">< Kembali</a></h2>
<div class="ui-widget">
    <input id="branchautocomplete" type="text" class="form-control" placeholder="* Nama Cabang"/>
    <div id="panel_confirmation" class="panel panel-default" style="margin-top: 10px; display: none;">
        ...
        <table class="table" style="margin: 0 auto; width: 90%;">
            ...
            <tbody>
                <tr>
                    <td><span id="branch_selected"></span></td>
                    <td><span id="branch_selected_name"></span></td>
                    <td><span id="branch_selected_phone"></span></td>
                    <td><span id="branch_selected_address"></span></td>
                </tr>
                <tr>
                    <td colspan="4" style="text-align: center; font-size: 140%;">
                        ...
                        <span id="btn_add_trans_branch" class="label label-success" style="cursor: pointer; font-weight: bold;">Ya, Lanjutkan</span>
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                        {!! Form::open(['id' => 'form_add_trans', 'route' => 'do.cashier.add-transaction']) !!}
                            ...
                            <input type="hidden" name="add_trans_for_branch" id="add_trans_for_branch" value=""/>
...
<input type="hidden" id="get_branches" value="{{route('get.branchesfor.cashier')}}" />
@endsection
