...
var ItemAutoComplete = function() {
    return {
        ...
        init: function () {
            var cache = {};
            $("#jsSearchSeriesItemKeyword").autocomplete({
                minLength: 3,
                ...
                source: function( request, response ) {
                    ...
                    //     return;
                    // }
                    $.getJSON($('#jsUrlGetSeriesItemsAutoComplete').val().replace('trans_id',$('#jsViewedOngoingTransId').val()), request, function( data, status, xhr ) {
                            // cache[term] = data;
                            response(data);
                        });
                },
